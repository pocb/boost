...
message("BoostConfigVersion: AVAILABLE_VERSIONFILES=${AVAILABLE_VERSIONFILES}")
...
elseif(AVAILABLE_VERSIONFILES)
  ...
  message("revlist = ${AVAILABLE_VERSIONFILES}")
  list(GET AVAILABLE_VERSIONFILES 0 MOSTRECENT)
  message("Greatest version found is ${MOSTRECENT}")
